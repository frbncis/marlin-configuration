...
//#define LCD_SHOW_E_TOTAL
  ...
  // Default is G28XY, changed to instead send stop command to OctoPrint
  #define EVENT_GCODE_SD_STOP "M118 A1 action:cancel"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
